...
const Dashboard = () => {
  ...
  const [loadingFitch, setLoadingFitch] = useState(false);
            ...
            return (
              ...
              >
                ...
                <p className="absolute bottom-1 text-[11px] text-slate-400 group-hover:text-slate-500 transition-all duration-300 px-2 text-center">
                  Update on {new Date(item.updatedAt).toLocaleDateString()}
                </p>
                <div
        ...
        {showCreateResume && (
          ...
          >
            ...
            >
              ...
              <XIcon
                className="absolute top-4 right-4 text-slate-400 hover:to-slate-600 cursor-pointer transition-colors"
                onClick={() => {
                  setShowCreateResume(false);
                  setTitle("");
                }}
              ...
              <div>
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center gap-2 border group text-slate-400 border-slate-400 border-dashed rounded-md p-4 py-10 my-4 hover:border-green-500 hover:text-green-700 cursor-pointer transition-colors">
                    {resume ? (
                      <p className="to-green-700">{resume.name}</p>
                    ) : (
                      <>
          ...
          >
            ...
            >
              ...
              <input
                ...
                required
              />
              <button disabled={loading} className="w-full py-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors">
