                ...
                <div className="px-4 md:px-0" onMouseEnter={() => setIsHover(true)} onMouseLeave={() => setIsHover(false)}>
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Smart Formatting & Design</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Automatically formats your content into a professional, clean layout, ensuring your resume is ATS-friendly</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                    ...
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Professional Cover Letter Generator</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Automatically generate a tailored cover letter that matches the resume's format and highlights the user's key skills for the specific job they are targeting.</p>
                            </div>
                        </div>
                    </div>
                </div>
