       ...
       const cardsData = [
        {
            ...
            name: 'Briar Martin',
            handle: '@neilstellar',
            text:"As a fresh graduate, I had no idea how to build a professional resume. This tool guided me step-by-step.",
        },
        {
            image: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=200',
            name: 'Avery Johnson',
            handle: '@averywrites',
            text:"I got my first interview within a week!",
        },
        {
            image: 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=200&auto=format&fit=crop&q=60',
            name: 'Jordan Lee',
            handle: '@jordantalks',
            text:"The interface is super intuitive. I am not good with technology, but I finished my resume in 20 minutes.",
        },
        {
            image: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=200&auto=format&fit=crop&q=60',
            name: 'Avery Johnson',
            handle: '@averywrites',
            text:"I loved how it automatically formatted my messy old CV. It looks so clean and modern now.",
        },
    ];
